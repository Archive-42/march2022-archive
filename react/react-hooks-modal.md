...
For the full and most up to date implementation of this component, check out [this site's Github repo](https://github.com/bgoonz/blog/tree/main/src/components/Modal).
