...
<table style="width:99%;"><colgroup><col style="width: 17%" /><col style="width: 24%" /><col style="width: 57%" /></colgroup><thead><tr class="header"><th></th><th><code>(state) =&gt; stateProps</code></th><th><code>(state, ownProps) =&gt; stateProps</code></th></tr></thead><tbody><tr class="odd"><td><code>mapStateToProps</code> runs when:</td><td>store <code>state</code> changes</td><td>store <code>state</code> changes<br />
or<br />
any field of <code>ownProps</code> is different</td></tr><tr class="even"><td>component re-renders when:</td><td>any field of <code>stateProps</code> is different</td><td>any field of <code>stateProps</code> is different<br />
or<br />
any field of <code>ownProps</code> is different</td></tr></tbody></table>
